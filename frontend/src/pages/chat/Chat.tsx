                            ...
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    <h1 className={styles.chatEmptyStateTitle}>Start chatting</h1>
                                        <h2 className={styles.chatEmptyStateSubtitle} style={{ fontSize: "18px" }}>Welcome! I am UMA's Chat Bot designed to answer questions about specific People & Culture topics,
                                        <br></br>
                                        such as policies, training, procedures, training, leave, termination, orders, appeals, timesheets and terminoloy.
                                        <br></br>
                                        Please be patient with me as I am still learning &#128522;
                                    </h2>
                                    {/* <h3 className={styles.chatEmptyStateSubtitle} style={{ fontSize: "18px" }}>Please be patient with me as I am still learning &#128522;</h3> */}
                            </Stack>
                        ) : (
